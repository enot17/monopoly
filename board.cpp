...
public:
    ...
    void draw() {
        ...
        DrawText(names[index++], OPP_SIDE + CELL_W - 50, OPP_SIDE + (CELL_H / 2 - FONT_SIZE), BIG_FONT_SIZE,BLACK);
        ...
        for (int i = 0; i < ROW_COUNT; i++) {
            ...
            DrawText(names[index++], BIG_CELL_SIZE + CELL_W * i, OPP_SIDE + 20, FONT_SIZE,BLACK);
        }


        for (int i = 0; i < ROW_COUNT; i++) {
            DrawRectangleLines(CELL_H + CELL_W * i, 0, CELL_W, CELL_H, PURPLE);
            // DrawText(names[index], 100, 100, 20,RED);
            // index++;
        }
        ...
        DrawRectangleLines(OPP_SIDE, 0, CELL_H, CELL_H, BLACK);
